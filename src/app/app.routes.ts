...
export const routes: Routes = [
  ...
  { path: "movies/:uuid", loadComponent: () => import("./features/items/movie/movie.component").then((m) => m.MovieComponent) },
  { path: "posts", loadComponent: () => import("./features/posts/posts.component").then((m) => m.PostsComponent) },
  { path: "posts/:id", loadComponent: () => import("./features/posts/replies/replies.component").then((m) => m.RepliesComponent) },
];
