...
export class ExternalResourcesComponent implements OnChanges {
  ...
  resourcesDict: { [key: string]: ResourceItem } = {
    ...
    "bandcamp.com": { title: "Bandcamp", class: "bg-cyan-500" },
    "bangumi.tv": { title: "Bangumi", class: "bg-red-300" },
    "bgm.tv": { title: "Bangumi", class: "bg-red-300" },
    "boardgamegeek.com": { title: "BGG", class: "bg-orange-600" },
    "bibliotek.dk": {
      title: "Bibliotek.dk",
      class: "bg-indigo-600 text-neutral-50",
    },
    "ereolen.dk": { title: "eReolen.dk", class: "bg-rose-700 text-neutral-50" },
    "books.com.tw": { title: "BooksTW", class: "bg-lime-500" },
    "discogs.com": {
      title: "Discogs",
    ...
    "goodreads.com": { title: "Goodreads", class: "bg-stone-100" },
    "books.google.com": {
      title: "Google Books",
      class: "bg-blue-500 text-neutral-50",
    },
    "igdb.com": { title: "IGDB", class: "bg-violet-500 text-neutral-50" },
    "imdb.com": { title: "IMDB", class: "bg-yellow-400" },
    "jjwxc.net": { title: "JinJiang", class: "bg-lime-500" },
    "musicbrainz.org": { title: "MusicBrainz", class: "bg-orange-400" },
    "openlibrary.org": {
      title: "Open Library",
      class: "bg-slate-500 text-neutral-50",
    },
    "qidian.com": { title: "Qidian", class: "bg-red-700 text-neutral-50" },
    "open.spotify.com": { title: "Spotify", class: "bg-green-500" },
    "store.steampowered.com": { title: "Steam", class: "bg-sky-500" },
    "themoviedb.org": { title: "TMDB", class: "bg-emerald-300" },
    "tmdb.org": { title: "TMDB", class: "bg-emerald-300" },
    "wikidata.org": { title: "WikiData", class: "bg-sky-700 text-neutral-50" },
    "ypshuo.com": { title: "Ypshuo", class: "bg-red-500" },
  };
